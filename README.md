...
-- 2.1 Identify total number of sales on 2022-11-05.
...
-- 2.2 Identify transactions in clothing category, quantity soled is more than 4 in month of november.
...
-- 2.3 Identify total sales for each category
...
-- 2.4 Identify average age of customer who purchased item from beauty category
...
-- 2.5 Identify transactions where total sales is greater than 1000
...
-- 2.6 Identify total number of transcations (transaction_id) made by each gender in each category.
...
-- 2.7 Calculate the average sales for each month and identify the top-selling month, along with its average sales, for each year.
...
-- 2.8 Identify total number of unique customers who purchased items from each category.
...
-- 2.9 Count the number of orders for each shift (Morning, Afternoon, and Evening) to identify the peak sales period during the day.
